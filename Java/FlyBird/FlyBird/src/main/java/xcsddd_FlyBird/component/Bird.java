...
import xcsddd_FlyBird.app.Game;
import xcsddd_FlyBird.util.Constant;
import xcsddd_FlyBird.util.GameUtil;
...
//      g.drawRect((int) birdRect.getX(), (int) birdRect.getY(), (int) birdRect.getWidth(), (int) birdRect.getHeight());
    ...
    public static final int ACC_FLAP = 14; // 玩家拍打速度
    public static final double ACC_Y = 2; // 玩家向下加速
    public static final int MAX_VEL_Y = 15; // 沿 Y 轴的最大爬行速度，最大下降速度
    private int velocity = 0; // 鸟沿 Y 轴的速度，默认值与 playerFlapped 相同
