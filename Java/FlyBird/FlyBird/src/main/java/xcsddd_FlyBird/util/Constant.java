...
public class Constant {
	...
	// 游戏标题
	public static final String GAME_TITLE = "Fly Bird written by xcsddd";
	...
	public static final String[][] BIRDS_IMG_PATH = {
			...
			{ "resources/img/up.png", "resources/img/up.png", "resources/img/up.png", "resources/img/up.png",
					"resources/img/up.png", "resources/img/up.png", "resources/img/up.png", "resources/img/up.png" },
			{ "resources/img/down_1.png", "resources/img/down_2.png", "resources/img/down_0.png",
	...
	// 游戏背景色
	public static final Color BG_COLOR = new Color(0xEE82EE);
